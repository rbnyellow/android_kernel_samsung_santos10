...
0x2400, /*IPPG_IVCM2               */
0x376F,
0x39C5, /*RiseSx_CDS_1_L_Addr      */
0x511E, /*Fallcreset_1_L           */
...
0x170A, /*gPT_u8Adf_APMinVal_BP2_1_SDM  */
...
/*----------------*/
0xFF86,
0x7C02,	/* lux threshold for CNFTh1	*/
0xFF85,
0x2493,	/* CNFTh1 @ current_lux <  lux_thrd(0x867C)*/
0x3AB3,	/* CNFTh1 @ current_lux >= lux_thrd(0x867C)*/
/*----------------*/
/* ADF - CNFTh2   */
/*----------------*/
0xFF85,
0x13ED,	/* lux threshold for CNFTh2([7:4] : max_lux, [3:0] min_lux)*/ 
0x250B,	/* CNFTh2 @ min lux level                                  */
0x3B08,	/* CNFTh2 @ max lux level                                  */
/*----------------*/
/* ADF - CNFTh3, 4*/ 
/*----------------*/
0xFF86,
...
0x7E06,	/* CNFTh3 @ #1 light source [0x83D3:0x01] - CWF, TL84                   */
0x8119,	/* CNFTh4 @ #1 light source [0x83D3:0x01] - CWF, TL84                   */
...
0xC120,	/* EDEOption value over lux level threshold     */
0xC220,	/* EDEOption value under lux level threshol     */
...
0x2613, /*gPR_Active_720P_u8PLL_M_Addr*/
...
0x5013, /*gPR_Active_VGA_u8PLL_M_Addr*/
...
// Skip Frame
0xFF87,
0x2462, /*gPR_Active_720P_u8SensorMode_Addr*/
0xFF87, /*Page mode*/
0x4E62, /*gPR_Active_VGA_u8SensorMode_Addr*/
0xFF86, /*Page mode*/
0xFA62, /*gPR_Active_SXGA_u8SensorMode_Addr*/

// Fast AE
0xFF87,
0xd802, //gUR_u8CoarIntTime_Addr0
0xd925, //gUR_u8CoarIntTime_Addr1
0xda04, //gUR_u8FrmLength_Addr0
0xdb4c, //gUR_u8FrmLength_Addr1
0xec28, //gUR_u8so1_Addr
0xf454, //gUR_u8si1_Addr
...
/*===========================================*/
/* Capture후 Preview 복귀 셋팅 셋팅 */
/*============================================*/
static const u16 db8131m_stop_to_preview[] = {
0xE782,		/*Wait 130*/
...
0x4E72, /*gPR_Active_VGA_u8SensorMode_Addr*/
0xFF86, /*Page mode*/
0xFA72, /*gPR_Active_SXGA_u8SensorMode_Addr*/
...
//------------------------------------------
// Size - Capture 960x720
static const u16 db8131m_capture_960x720[] = {
0xFFB0,	// Page Mode
0x1407,		// MIPI_VGA_WORD_COUNT_Addr0
...
0xB302,
0xB4FF,
0xB500,		// UR_u8SCLCropStartX_Addr0
0xB600,		// UR_u8SCLCropStartX_Addr1
0xB700,		// UR_u8SCLCropStartY_Addr0
0xB820,		// UR_u8SCLCropStartY_Addr1
0xB903,		// UR_u8SCLCropEndX_Addr0
0xBAC0,		// UR_u8SCLCropEndX_Addr1
0xBB02,		// UR_u8SCLCropEndY_Addr0
0xBCF0,		// UR_u8SCLCropEndY_Addr1

	0xFF85,	// PR
	0xB807,		// gPT_u8PR_Active_SXGA_WORD_COUNT_Addr0
	0xB980,		// gPT_u8PR_Active_SXGA_WORD_COUNT_Addr1

	0xFF85, // Page Mode
	0xB101,		// u8PR_Active_SXGA_HvalidOffset_Addr

	0xFF87,	// Page Mode
	0x0502,		// gPR_Active_SXGA_u8SCLCtrl_Addr
	0x0602,		// gPR_Active_SXGA_u8SCLHorScale_Addr0
	0x07FF,		// gPR_Active_SXGA_u8SCLHorScale_Addr1
	0x0802,		// gPR_Active_SXGA_u8SCLVerScale_Addr0
	0x09FF,		// gPR_Active_SXGA_u8SCLVerScale_Addr1
	0x0A00,		// gPR_Active_SXGA_u8SCLCropStartX_Addr0
	0x0B00,		// gPR_Active_SXGA_u8SCLCropStartX_Addr1
	0x0C00,		// gPR_Active_SXGA_u8SCLCropStartY_Addr0
	0x0D20,		// gPR_Active_SXGA_u8SCLCropStartY_Addr1
	0x0E03,		// gPR_Active_SXGA_u8SCLCropEndX_Addr0
	0x0FC0,		// gPR_Active_SXGA_u8SCLCropEndX_Addr1
	0x1002,		// gPR_Active_SXGA_u8SCLCropEndY_Addr0
	0x11F0,		// gPR_Active_SXGA_u8SCLCropEndY_Addr1
...
//------------------------------------------
// Size - Capture 1280x960
static const u16 db8131m_capture_1280x960[] = {
0xFFB0,	// Page Mode
0x140A,		// MIPI_VGA_WORD_COUNT_Addr0
0x1500,		// MIPI_VGA_WORD_COUNT_Addr1
...
0xB700,		// UR_u8SCLCropStartY_Addr0
0xB820,		// UR_u8SCLCropStartY_Addr1
0xB905,		// UR_u8SCLCropEndX_Addr0
0xBA00,		// UR_u8SCLCropEndX_Addr1
0xBB03,		// UR_u8SCLCropEndY_Addr0
0xBCE0,		// UR_u8SCLCropEndY_Addr1
	...
	0xFF87,	// Page Mode
	0x0502,		// gPR_Active_SXGA_u8SCLCtrl_Addr
	0x0603,		// gPR_Active_SXGA_u8SCLHorScale_Addr0
	0x07FF,		// gPR_Active_SXGA_u8SCLHorScale_Addr1
	0x0803,		// gPR_Active_SXGA_u8SCLVerScale_Addr0
	0x09FF,		// gPR_Active_SXGA_u8SCLVerScale_Addr1
	0x0A00,		// gPR_Active_SXGA_u8SCLCropStartX_Addr0
	0x0B00,		// gPR_Active_SXGA_u8SCLCropStartX_Addr1
	0x0C00,		// gPR_Active_SXGA_u8SCLCropStartY_Addr0
	0x0D20,		// gPR_Active_SXGA_u8SCLCropStartY_Addr1
	0x0E05,		// gPR_Active_SXGA_u8SCLCropEndX_Addr0
	0x0F00,		// gPR_Active_SXGA_u8SCLCropEndX_Addr1
	0x1003,		// gPR_Active_SXGA_u8SCLCropEndY_Addr0
	0x11E0,		// gPR_Active_SXGA_u8SCLCropEndY_Addr1
...
0xFF85, // Page Mode
0xB301,		// u8PR_Active_VGA_HvalidOffset_Addr
...
//------------------------------------------
// Effect Black & White
static const u16 db8131m_Effect_Black_White[] = {
	0xFF87,
	0xBD08,
	0xBE00,
	0xBF00,
...
static const u16 db8131m_60Hz[] = {
0xFF82,
0x925D,
};
static const u16 db8131m_50Hz[] = {
0xFF82,
0x9259,
};

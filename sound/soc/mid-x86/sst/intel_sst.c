...
/*GPIO pins used for SSP0 */
#define CLV_I2S_0_CLK_GPIO_PIN  4
#define CLV_I2S_0_FS_GPIO_PIN   5
#define CLV_I2S_0_TXD_GPIO_PIN  6
#define CLV_I2S_0_RXD_GPIO_PIN  7

/* FIXME: Remove the hardcoding after SSP changes */
#define SSP_BASE_CTP 0xFFA20000
			...
			const struct pci_device_id *pci_id)
{
	...
	if (sst_drv_ctx->pci_id == SST_CLV_PCI_ID) {
		...
		lnw_gpio_set_alt(CLV_I2S_0_CLK_GPIO_PIN, LNW_ALT_1);
		lnw_gpio_set_alt(CLV_I2S_0_FS_GPIO_PIN, LNW_ALT_1);
		lnw_gpio_set_alt(CLV_I2S_0_TXD_GPIO_PIN, LNW_ALT_1);
		lnw_gpio_set_alt(CLV_I2S_0_RXD_GPIO_PIN, LNW_ALT_1);
#else

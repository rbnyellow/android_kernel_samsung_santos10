...
extern void __sec_debug_cpufreq_log(int cpu, int freq);
...
static inline void sec_debug_cpufreq_log(int cpu, int freq)
{

	if (unlikely(sec_debug_level.en.kernel_fault))
		__sec_debug_cpufreq_log(cpu, freq);
}
...
#define sec_debug_cpufreq_log(cpu, freq)
#ifdef CONFIG_SEC_DEBUG_XEN

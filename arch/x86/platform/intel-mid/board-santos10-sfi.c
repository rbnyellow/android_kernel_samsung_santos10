...
#if defined(CONFIG_SAMSUNG_MHL_8246) && defined(CONFIG_SAMSUNG_MHL_92X4)
...
#if defined(CONFIG_SAMSUNG_MHL_8246) && defined(CONFIG_SAMSUNG_MHL_92X4)
static struct sfi_device_table_entry __initconst santos10_sfi_table_rev10[] = {
	{SFI_DEV_TYPE_IPC,  0, 0x00, 0x49, 25000000, "a_gfreq"},
	{SFI_DEV_TYPE_IPC,  0, 0x00, 0x4a, 25000000, "a_socdts"},
	{SFI_DEV_TYPE_IPC,  0, 0x00, 0x4b, 25000000, "a_dramr"},
	{SFI_DEV_TYPE_IPC,  0, 0x00, 0x4c, 25000000, "a_dispon"},
	...
	{SFI_DEV_TYPE_I2C,  4, 0x2D, 0xFF, 400000, "s5k5ccgx"},
	{SFI_DEV_TYPE_I2C,  4, 0x45, 0xFF, 400000, "db8131m"},
#ifdef CONFIG_REGULATOR_NCP6914
	{SFI_DEV_TYPE_I2C,  4, (0x20>>1), 0xFF, 400000, "ncp6914"},            /* VE_GROUP */
#endif
	{SFI_DEV_TYPE_I2C,  5, 0x2E, 0xFF, 400000, "geomagnetic"},
	{SFI_DEV_TYPE_I2C,  5, 0x29, 0xFF, 400000, "bh1730fvc"},
	{SFI_DEV_TYPE_I2C,  5, 0x19, 0xFF, 400000, "accelerometer"},
	...
	{SFI_DEV_TYPE_I2C, 10, 0x39, 0xFF, 400000, "sii8246_mhl_tx"},
	{SFI_DEV_TYPE_I2C, 10, 0x3D, 0xFF, 400000, "sii8246_tpi"},
	{SFI_DEV_TYPE_I2C, 10, 0x49, 0xFF, 400000, "sii8246_hdmi_rx"},
	{SFI_DEV_TYPE_I2C, 10, 0x64, 0xFF, 400000, "sii8246_cbus"},
#endif
...
#if defined(CONFIG_SAMSUNG_MHL_8246) && defined(CONFIG_SAMSUNG_MHL_92X4)
	if (sec_board_rev > 9)
		return santos10_sfi_table_rev10;
	else
#endif
...
#if defined(CONFIG_SAMSUNG_MHL_8246) && defined(CONFIG_SAMSUNG_MHL_92X4)
	if (sec_board_rev > 9)
		return ARRAY_SIZE(santos10_sfi_table_rev10) - 1;
	else
#endif

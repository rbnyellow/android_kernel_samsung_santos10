...
#if defined (CONFIG_REGULATOR_NCP6914)
#include "sec_libs/platform_ncp6914.h"
#endif
...
static struct devs_id __initconst santos10_devs_r00[] = {
	...
	{"ncp6914", SFI_DEV_TYPE_I2C, 0, &ncp6914_platform_data, NULL},   /* VE_GROUP */
#endif
	...
	{"sii8246_mhl_tx", SFI_DEV_TYPE_I2C, 0, &sii8246_platform_data},
	{"sii8246_tpi", SFI_DEV_TYPE_I2C, 0, &sii8246_platform_data},
	{"sii8246_hdmi_rx", SFI_DEV_TYPE_I2C, 0, &sii8246_platform_data},
	{"sii8246_cbus", SFI_DEV_TYPE_I2C, 0, &sii8246_platform_data},
#endif
